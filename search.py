...
def graph_search(problem, fringe):
    ...
    while fringe:
        node = fringe.pop()
        if problem.goal_test(node.state):
            #print ("El numero de nodos expandidos es: " + str(cont))
            return CompGen(node, cont)
...
def ram_aco_graph_search(problem):
    return graph_search(problem, RamacoFringe())

def ram_aco_heur_graph_search(problem):
    return graph_search(problem, RamacoFringeHeur(problem))
